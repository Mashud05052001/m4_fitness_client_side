            ...
            <div className="hero ">
                <div className="hero-content flex-col lg:flex-row-reverse">
                    ...
                    <div className='lg:mr-10'>
                        <h1 className="mb-5 text-3xl float-left   md:text-5xl font-bold text-[#e39d2b]">Mashudur Rahman</h1><br />
                        <div className="pt-2 pb-6 text-xl font-semibold">
                            Professional gym Trainer <br />
                            <p className='mb-4'>
